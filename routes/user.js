  ...
  router.post(
    ...
    async function (req, res) {
      ...
      try {
        ...
        res
          .status(200)
          .json({ idUser: userId, msg: "Register user successfully" });
      } catch (error) {
        res
          .status(500)
          .json({ error: error, msg: "Register user unsuccessfully" });
      }
    }
  );
    ...
    async function (req, res) {
      ...
      try {
        ...
        if (userGet) {
          ...
          res
            .status(200)
            .json({ idUser: userUpdateId, msg: "Edit user successfully" });
        } else {
          res.status(400).json({ msg: "user no exist" });
        }
      } catch (error) {
  ...
  router.delete("/:userId", async function (req, res) {
    ...
    try {
      ...
      if (user) {
        ...
        res
          .status(200)
          .json({ idUser: deleteId, msg: "Delete user successfully" });
      }else{
      ...
      res
        .status(500)
        .json({ error: error.message, msg: "Delete user unsuccessfully" });
    }
  });
}
